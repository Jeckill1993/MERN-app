...
function Slider() {
    ...
    this.currents = null;
    this.getImage = null;
    this.getButtonPrev = null;
    this.getButtonNext = null;
    this.initialization = function (containerID) {
        let that = this;
    ...
    this.clickPrevBtn = function (event) {
        this.currents--;
        if (this.currents < 0) {
    ...
    this.clickNextBtn = function (event) {
        this.currents++;
